...
public:
    ...
    VisitRule                   unite_rule;
    VisitRule                   separate_rule;
    
    /*  The optimal columns selected by the LP solver with the coefficient */
    vector<pair<Column, float>> base_columns;
    
    /*  Lower bound obtained by solving LP; if the solution is integral,
    ...
    BBNode(const Problem& prob,
           ...
           const VisitRule unite_rule,
           const VisitRule separate_rule);
